...
class Post_Types {
	...
	public static function init() {
		...
		add_action( 'init', array( __CLASS__, 'register_slides' ) );
	...
	public static function register_slides() {
		$labels = Post_Types::get_label_defaults();
		$labels['name']                  = _x( 'Reveal Slides', 'Post Type General Name', 'starter_plugin' );
		$labels['singular_name']         = _x( 'Reveal Slides', 'Post Type Singular Name', 'starter_plugin' );
		$labels['all_items']             = __( 'All Reveal Slides', 'starter_plugin' );
		$labels['menu_name']             = __( 'Reveal Slides', 'starter_plugin' );
		$labels['name_admin_bar']        = __( 'Reveal Slides', 'starter_plugin' );

		$args = Post_Types::get_args_defaults();
		$args['label']               = __( 'Reveal Slides', 'starter_plugin' );
		$args['description']         = __( 'Reveal Slides items', 'starter_plugin' );
		$args['labels']              = $labels;
		$args['menu_icon']           = 'dashicons-clipboard';
		$args['rewrite']             = array( 'with_front' => false, 'slug' => 'reveal-slides' );
