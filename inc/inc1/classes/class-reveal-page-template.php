...
class Reveal_Page_Template {
	...
	public function __construct() {
		...
		add_shortcode( 'present-with-reveal', array( $this, 'present_with_reveal_js' ) );
	}
...
Tetradic Color
	...
	*- Matt Mullenweg*
	...
	<?php
		...
		public function present_with_reveal_js() {
			?>
	<!doctype html>
	<html lang="en">
